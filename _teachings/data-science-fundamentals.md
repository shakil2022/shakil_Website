...
description: This course introduces the fundamental concepts of cyber security, ethical hacking, and digital forensics. Students will learn about common cyber attacks, web vulnerabilities, authentication, security tools, forensic techniques, cryptography, blockchain security, and cybersecurity law.
...
schedule:
  ...
  - week: 1
    ...
    description: Introduction to cyber security, CIA triad, key security issues, incident management, penetration testing, digital evidence, evidence handling, and chain of custody.
    materials:
      - name: Cybersecurity Essentials
        url: /assets/pdf/example_pdf.pdf
      - name: Guide to Computer Forensics and Investigations
        url: /assets/pdf/example_pdf.pdf
  ...
  - week: 12
    ...
    description: Introduction to cryptographic concepts, cryptography techniques, and hashing algorithms used in cybersecurity.
    materials:
  ...
  - week: 13
    ...
    materials:
      - name: Lecture Notes
        url: /assets/pdf/example_pdf.pdf
      - name: Cybersecurity and Cyberlaw
        url: /assets/pdf/example_pdf.pdf
...
This course provides a comprehensive introduction to cyber security, ethical hacking, and digital forensics. By the end of this course, students will be able to:
